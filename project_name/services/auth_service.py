...
import project_name.database.db_handlers.auth_db_handler as admin_user_db_handler
from uuid import UUID, uuid4
from fastapi import HTTPException
from project_name.services.service_utils.exception_collection import (
    CreateError,
    DuplicateError,
    NotFound,
    UpdateError,
)
import project_name.services.service_utils.gr_redis_utils as redis_utils
import project_name.services.service_error_enums as service_errors
import project_name.services.service_utils.auth_utils as auth_utils
import json
import project_name.services.service_utils.token_utils as gr_toks_utils
from project_name.root.utils.mailer import send_mail
